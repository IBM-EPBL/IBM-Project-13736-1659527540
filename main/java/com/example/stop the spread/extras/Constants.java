package com.example.stop the spread.extras;
...
public abstract class Constants {
    ...
    public static final String LOCATION_SETTINGS_SHARED_PREFERENCES="com.example.stop the spread.location-settings-pref";
    public static final String location_tracker_state = "com.example.stop the spread.tracker-state";

    public static final String background_WorkerTag = "com.example.stop the spread.bg-worker-tag";

    public static final String WORKER_SHARED_PREFERENCES="com.example.stop the spread.bg-worker-pref";
     ...
     */
    public static final String MISC_SHARED_PREFERENCES = "com.example.stop the spread.misc-pref";
    public static final String bg_worker_state = "com.example.stop the spread.worker-state";
    public static final String upload_state = "com.example.stop the spread.upload-state";
